;(window.webpackJsonp = window.webpackJsonp || []).push([
  [15],
  {
    ...
    Ofmp: function (e, l, t) {
      ...
      function At(e) {
        if (Array.isArray(e)) {
          for (var l = 0, t = Array(e.length); l < e.length; l++) t[l] = e[l]
          return t
        }
        return Array.from(e)
      }
      var yt = { small: 16, medium: 32, large: 64 },
        Nt = { top: 'text-top', middle: 'middle' },
        St = [16, 16]
      function bt(e) {
        var l = e.ariaLabel,
          t = e.children,
          ...
          z =
            'function' == typeof h
              ? c.default.createElement(h, null)
              : c.default.Children.only(t),
          r = z.type.size || St,
          i = {
            ...
            height: a,
            role: 'img',
            viewBox: [0, 0].concat(At(r)).join(' '),
          }
        if (u && a) Object.assign(i, { width: u, height: a })
        else {
          var m = { width: r[0], height: r[1] },
            f = u ? 'width' : 'height',
            o = 'width' === f ? 'height' : 'width'
          ;(i[f] = u || a || yt[v] || v), (i[o] = i[f] * (m[o] / m[f]))
        }
        return (
          (i.style = {
            ...
            fill: 'currentColor',
            userSelect: 'none',
            verticalAlign: Nt[d] || d,
          }),
          c.default.createElement('svg', i, z)
        )
      }
      bt.defaultProps = {
        className: 'octicon',
          ...
          return c.default.createElement(
            ...
            c.default.createElement(
              ...
              c.default.createElement(
                'a',
                {
                  href: 'https://github.com' + l.resourcePath,
                  target: '_blank',
            ...
            1 == t.length &&
              c.default.createElement(
                ...
                c.default.createElement('span', {
                  className: It.a.languageBadge,
                  style: { backgroundColor: t[0].node.color },
                }),
                ' ',
                t[0].node.name
              ),
            ...
            c.default.createElement(
              ...
              a &&
                c.default.createElement(
                  ...
                  c.default.createElement(
                    'a',
                    { href: 'https://github.com/kwapoong', className: 'btn' },
                    'See more on GitHub'
                  )
                )
            )
        ...
        return c.default.createElement(
          ...
          c.default.createElement(
            ...
            c.default.createElement(
              ...
              c.default.createElement(n.Link, { to: v }, l)
            ),
            c.default.createElement(
              'div',
              { className: d.a.meta },
              t &&
                c.default.createElement(
                  ...
                  c.default.createElement(
                    'time',
                    { className: d.a.date + ' dt-published', dateTime: t },
                    a
                  )
                ),
              z &&
    ...
    sFJ3: function (e, l, t) {
      e.exports = {
        repository: 'repository-module--repository--2vKzn',
        header: 'repository-module--header--3a95d',
        name: 'repository-module--name--ZNEwX',
        footer: 'repository-module--footer--3pX8F',
        footerItem: 'repository-module--footerItem--1Gdum',
        languageBadge: 'repository-module--languageBadge--3bUST',
        description: 'repository-module--description--3_Dd9',
        customMedia: {},
        customProperties: {},
        customSelectors: {},
      }
